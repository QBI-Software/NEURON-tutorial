...
<ol>
  <li>
  <h4>Variable</h4>
  <p>Programming languages allow you to store values which can be changed during the running of a program. These are given names of your choice and then set to a value with the `=` (equals) sign.</p>
  </li>
<li>
<h4>Procedure</h4>
...
<ol><li>It must first be <em>defined</em> which is written as <code>proc methodname()</code> and contains the actual code to run within curly brackets <code>{}</code></li>
 <li>To get the procedure to run, it is <em>called</em> by just writing the name and parentheses <code>methodname()</code></li>
 </ol>
 </li>
 </ol>
 </div>
